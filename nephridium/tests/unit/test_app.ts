...
describe('Tests index', () => {
  describe('removeAttributes', () => {
    ...
    it('handles no removal', () => {
      ...
      const result = app.removeAttributes(data, 'slug')
  ...
  describe('removeAttributes', () => {
    it('removes attributes from every row', () => {
      ...
      result.forEach((r: { a: any, b: any }) => (Boolean(expect(typeof r.a).to.equal('undefined'))) && expect(typeof r.b).to.equal('undefined'))
    })
  })
})
